...
## Task 1 — Migration `017_voice.py` : table `voice_sessions`
...
### Test first — `tests/test_migration_017_voice.py`
...
Run:
```bash
pytest tests/test_migration_017_voice.py -v
# Expected: 5 FAILED (file does not exist yet)
```

### Implementation — `migrations/017_voice.py`
...
Commit:
```
git add migrations/017_voice.py tests/test_migration_017_voice.py
...
- [ ] Task 1 — `migrations/017_voice.py` — `voice_sessions` table + index
...
| File | Action |
|------|--------|
| `migrations/017_voice.py` | Create |
...
| `tests/test_migration_017_voice.py` | Create |
